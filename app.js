...
const translations = {
  uz: {
    ...
    heroDesc: "Kursni asosiy maqsadi o'quvchilar matematikani asosini bilmaganligi sababli butunlay o'rganishni to'xtatib qo'yishadi , bu kurs no'ldan (elementar darajadan o'rgatilgan), o'quvchilarga mavzularni tushunishda va misollarni ishlashida asos bo'lib xizmat qiladi! ",
    ...
    for2Desc: "Farzandini Prezident va Al-Xorazmiy maktablariga olib kirishni rejalashtirayotgan, lekin birinchi navbatda asosiy mavzularni puxta o‘rgatib olishni istaydigan 3–4-sinf o‘quvchilarining ota-onalari uchun maxsus online kurs.",
